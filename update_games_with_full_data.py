#!/usr/bin/env python3
"""
Update complete_games.html to use the full 5k word dataset
"""
...
def create_updated_html():
    """Create updated HTML with full word dataset and no-repeat logic."""
...
<head>
    ...
    <title>🎮 Complete Word Games - 5K Words</title>
    <style>
...
<body>
    <div class="game-container">
        <div class="game-header">
            <h1 class="game-title">🎮 Complete Word Games</h1>
            <p class="game-subtitle">Five Exciting Vocabulary Game Modes</p>
            <div class="word-count">📚 4,963 Unique Words • No Repetition Guaranteed</div>
        </div>
        ...
        <div class="tab-container">
            ...
            <div class="tab-content active" id="classic-tab">
                <div class="game-description">
                    ...
                    <p>Multiple choice vocabulary questions with instant feedback from 4,963 unique words.</p>
                </div>
            ...
            <div class="tab-content" id="speed-tab">
                <div class="game-description">
                    ...
                    <p>Answer as many questions as possible in 60 seconds from our massive word database!</p>
                </div>
            ...
            <div class="tab-content" id="quiz-tab">
                <div class="game-description">
                    <h3>🧠 Quiz Master</h3>
                    <p>Take a 10-question vocabulary test with letter grades from our extensive database.</p>
                </div>
            ...
            <div class="tab-content" id="battle-tab">
                <div class="game-description">
                    <h3>⚔️ Word Battle</h3>
                    <p>Two-player word competition! First to 5 wins takes the victory.</p>
                </div>
                ...
                <div class="question-card" id="battle-question">
                    Click "Start Battle" to begin the word war!
                </div>
            ...
            <div class="tab-content" id="endurance-tab">
                <div class="game-description">
                    ...
                    <p>How long can you survive? Questions get harder as you progress through our word bank!</p>
                </div>
                ...
                <div class="question-card" id="endurance-question">
                    Click "Start Endurance" to test your limits!
                </div>
    ...
    <script>
        // Full word dataset from enrichedpdfplan.txt (4,963 words)
        ...
        // Global shuffled word array to prevent repetition across all games
        let shuffledWords = [...gameData].sort(() => Math.random() - 0.5);
        let globalWordIndex = 0;
        
        // Function to get next unique word
        function getNextWord() {{
            if (globalWordIndex >= shuffledWords.length) {{
                // Reshuffle when we've used all words
        ...
        function checkClassicAnswer() {{
            ...
            if (isCorrect) {{
                ...
                state.currentStreak++;
                showFeedback('classic-feedback', true, 'Excellent! 🎉');
            }} else {{
                state.currentStreak = 0;
                showFeedback('classic-feedback', false, 'Not quite right. The answer was: ' + state.correctAnswer);
            }}
        ...
        function checkSpeedAnswer(selectedAnswer) {{
            ...
            showFeedback('speed-feedback', isCorrect, isCorrect ? '✅ Correct!' : '❌ Wrong');
            updateScores('speed');
        ...
        function showQuizQuestion() {{
            ...
            displayOptions('quiz-options-area', question.options, (option) => {{
                ...
                setTimeout(() => {{
                    showFeedback('quiz-feedback', question.isCorrect, 
                        question.isCorrect ? '✅ Correct!' : '❌ Incorrect. Answer: ' + question.correctMeaning);
                }}, 500);
            }});
        ...
        function endQuiz() {{
            ...
            showFeedback('quiz-feedback', true,
                ...
                '<p>Grade: ' + grade + '</p>' +
                '<p>' + (score >= 80 ? 'Excellent work! 🏆' : 'Keep practicing! 📚') + '</p>'
            );
        ...
        function checkBattleAnswer(selectedAnswer) {{
            ...
            if (isCorrect) {{
                ...
                showFeedback('battle-feedback', true, 'Player ' + state.currentPlayer + ' scores! 🎉');
            }} else {{
                showFeedback('battle-feedback', false, 'Wrong! Answer: ' + state.currentWord.meaning);
            }}
            ...
            if (state.player1Score >= 5 || state.player2Score >= 5) {{
                ...
                setTimeout(() => {{
                    showFeedback('battle-feedback', true, 
        ...
        function resetBattle() {{
            ...
            updateBattleDisplay();
            document.getElementById('battle-question').innerHTML = 'Click "Start Battle" to begin the word war!';
        ...
        function generateEnduranceQuestion() {{
            ...
            // Get harder words as level increases (longer meanings)
        ...
        function checkEnduranceAnswer(selectedAnswer) {{
            ...
            if (isCorrect) {{
                ...
                state.level++;
                showFeedback('endurance-feedback', true, 'Correct! Level up! 🎉');
            }} else {{
                state.lives--;
                showFeedback('endurance-feedback', false, 'Wrong! Lost a life. Answer: ' + state.currentWord.meaning);
                
                if (state.lives <= 0) {{
                    setTimeout(() => {{
                        showFeedback('endurance-feedback', false, 
                            '<h3>💀 Game Over!</h3>' +
                            '<p>Final Level: ' + state.level + '</p>' +
                            '<p>Final Score: ' + state.score + '</p>' +
                            '<p>No words repeated! 🎯</p>'
                        );
                        state.isActive = false;
        ...
        function restartEndurance() {{
            ...
            updateEnduranceDisplay();
            document.getElementById('endurance-question').innerHTML = 'Click "Start Endurance" to test your limits!';
        ...
        // Initialize
        console.log('🎮 Word Games loaded with ' + gameData.length + ' unique words!');
        console.log('🔄 Global shuffling enabled - no repetition guaranteed!');
    ...
    with open('complete_games_5k.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print(f"✅ Updated HTML created: complete_games_5k.html")
    print(f"🎯 Features:")
    print(f"   • 4,963 unique words from enrichedpdfplan.txt")
    print(f"   • Global shuffling prevents repetition")
    print(f"   • Automatic reshuffling when all words used")
    print(f"   • All 5 game modes updated")
